<%-- 
    Document   : index.jsp
    Created on : Oct 28, 2021, 10:00:13 AM
    Author     : CuongP
--%>
                    ...
                    <div class="card bg-light mb-3">
                        ...
                        <ul class="list-group category_block">
                            <c:forEach items="${listCategory}" var="o">
                                <li class="list-group-item text-white"><a href="#">${o.type}</a></li>
                            </c:forEach>

                        </ul>
                    </div>
                    <div class="card bg-light mb-3">
                        <div class="card-header bg-success text-white text-uppercase">Mẫu mới nhất</div>
                        <div class="card-body">
                            <img class="img-fluid" src="${newItem.image}" />
                            <h5 class="card-title">${newItem.name}</h5>
                            <p class="card-text">${newItem.description}</p>
                            <p class="bloc_left_price">${newItem.price} $</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <c:forEach items="${listItem}" var = "o" >
                            <div class="col-12 col-md-6 col-lg-4">
                                <div class="card">
                                    <img class="card-img-top" src="${o.image}" alt="Card image cap" width="250px" height="250px">
                                    <div class="card-body">
